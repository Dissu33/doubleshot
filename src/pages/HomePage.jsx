                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {[
                            ...
                            >
                                <Link
                                    to={item.link}
                                    className="group relative bg-gradient-to-br from-black/60 to-zinc-900/60 backdrop-blur-sm border border-zinc-800 p-10 rounded-2xl overflow-hidden transition-all duration-300 hover:border-coffee-500 hover:shadow-2xl hover:shadow-coffee-900/30 block h-full"
                                >
